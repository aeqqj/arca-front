                ...
                <form action="" class="flex flex-col gap-6">
                    ...
                    <div class="flex flex-col gap-1 mb-1">
                        ...
                        <div class="relative">
                            ...
                            <button type="button" id="togglePassword" class="absolute right-4 top-1/2 -translate-y-1/2 text-fg3">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <p class="w-full text-center text-fg3 text-sm hover:text-fg3/90 transition-colors">already have an account? <a href="/auth/signin" class="underline">Sign in </a></p>
                    </div>
                </form>
            </div>
        </section>
