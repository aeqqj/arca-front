			...
			>
				<div class="flex gap-4">
					<img
						...
						class="w-12 h-12 rounded-xs mt-1 shrink-0"
					/>
					<div
						class="w-full flex justify-between items-start min-w-0"
					>
						<div class="flex flex-col gap-1">
							<span class="text-body-lg text-fg3"
						...
						<div
							class="p-1 hover:bg-bg5/60 transition-colors rounded-xs shrink-0"
						>
							<i
