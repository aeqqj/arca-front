...
const STAT_CONFIG: Record<StatCardType, { icon: string; label: string; id: string }> = {
...
export function statCard(type: StatCardType): string {
    ...
    return `
        <div class="flex-1 flex flex-col gap-4 p-5 bg-bg2 border border-border rounded-xs">
