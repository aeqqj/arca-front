    ...
    return `
        <div class="w-100 flex flex-col gap-2">
            <div class="w-full flex justify-between items-center">
                <label class="text-fg2">Attachments</label>
                ...
                <input type="file" id="attachments-input" class="hidden" multiple>
            </div>
            <div class="h-fit bg-bg2 border border-dashed border-border hover:bg-bg3/60 rounded-xs flex items-center justify-center relative transition-colors p-6 flex-col gap-4">
                <div class="w-full h-fit border border-border bg-bg4 p-4 flex gap-2 items-center hover:bg-bg5/80 transition-colors relative">
                    <button type="button" class="group absolute -top-2 -right-2 w-5 h-5 flex items-center justify-center rounded-xs bg-bg5 border border-border hover:bg-bg4 transition-colors">
