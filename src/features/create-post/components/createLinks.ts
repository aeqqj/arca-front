...
export function createLinks() {
    return `
        <div class="w-100 flex flex-col gap-2">
            ...
            <div class="h-fit bg-bg2 border border-dashed border-border hover:bg-bg3/60 rounded-xs flex flex-col items-center justify-center relative transition-colors p-6 gap-4">
                <div class="w-full h-fit border border-border bg-bg4 p-4 flex gap-2 items-center hover:bg-bg5/80 transition-colors relative">
                    ...
                    <div class="flex flex-col min-w-0 flex-1">
                        <p class="text-sm text-fg3 truncate">Spacey Electro & Techno Mix in the Twilight Zone | Tinzo</p>
