	...
	return /* HTML */ `
		<div class="w-200">
			<div class="relative">
				<img
					src="${cover}"
					class="h-74 w-full object-cover object-top rounded-xs"
				/>
				<img
					src="${avatar}"
					class="h-40 rounded-xs absolute -bottom-18 left-4"
				/>
			</div>
			<div class="p-4 flex flex-col gap-2">
				<div class="h-18 w-full flex justify-end">
					<button
						class="h-fit py-2 px-4 border bg-bg2 border-border text-body-md"
					>
						Edit Profile
					</button>
				</div>
				...
				<div class="flex flex-col gap-3">
					<p class="text-fg3">
						something something cool bio something something very
						cool bio :DD if u're looking at this u're a loseeeeer.
						XDDDDDDDDDD
					</p>
